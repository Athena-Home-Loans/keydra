...
class TestConfig(unittest.TestCase):
    ...
    def test__filter_nightly_with_batch_size(self):
        ...
        with patch.object(
            ...
            mk_gce.return_value = 'dev'
            filtered_secrets = self.client._filter(envs, all_secrets, rotate='nightly', batch_size=3)
    ...
    def test__filter_nightly_secondary_with_batch_size(self):
        ...
        with patch.object(
            ...
            mk_gce.return_value = 'dev'
            filtered_secrets = self.client._filter(envs, all_secrets, rotate='nightly-secondary', batch_size=3)
